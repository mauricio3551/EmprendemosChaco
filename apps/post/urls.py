...
urlpatterns = [
    ...
    path('comentario/<int:pk>/editar/', EditComentarioView.as_view(), name='editarComentario'),
    path('comentario/<int:pk>/eliminar/', DeleteComentarioView.as_view(), name='eliminarComentario'),
